...
$$
Lenet_{32×32}^{1}=Cv2_{5}^6Sp2_{2}^6Cv2_{5}^{16}Sp2_{2}^{16}Fc_{}^{120}Fc_{}^{84}Gc_{}^{10}
$$

$$
Lenet_{32×32}^{1}=(Cv2_{5}Sp2_{2})_{}^{6,16]}Fc_{}^{'[120,64]'}Gc_{}^{10}
$$

$$
Lenet_{32×32}^{1}=(Cv_{5}Sp_{2})2_{}^{[6,16]}Fc_{}^{[120,64]}Gc_{}^{10}\\=(Cv_{5}Sp_{2})_{}^{[6,16]}Fc_{}^{[120,64]}Gc_{}^{10}
$$
